<main role="main" class="ml-sm-auto px-4">
    ...
    <div class="col-md-12 mb-5 pb-2 pt-3 border-bottom">
        <div class="row">
            <div class="col-md-10">
                <h3>Panel de evaluación de la calidad global de Registros Administrativos aprovechados con fines estadísticos.</h3>
            </div>
    ...
    <div class="col-md-12 mb-5">
        <div class="row">
            <div class="col-md-12 mb-5 text-center">
                <h3>Evaluación: <?=$periodos['nom_periodo']?> <?=$periodos['nom_dependencia']?></h3>
            </div>
            <div class="col-md-3">
            </div>
            ...
            <div class="col-md-5">
                <h4 class="mb-5 mt-3">Cualitativo: <?= $resultado_calidad_global ?></h4>
    ...
    <div class="row">
        ...
        <div class="col-md-8 mb-3">
            <div class="row">
                <p><small><strong>Para efectos del resultado cualitativo: <br />
                * El registro administrativo será calificado como "no aceptable" en los casos que se responda a alguna pregunta con el equivalente a "Sin información". <br />
                * El registro administrativo será calificado como "no aceptable" en los casos que se obtengan más de tres alertas. <br />
                * El índice de calidad global proporciona una evaluación integral derivada de los cuatro elementos de la calidad.</strong></small></p>
            </div>
        </div>
    </div>
