            ...
            <div class="row">
                ...
                <div class="col-sm-7 alternate-color">
                    <div class="row">
                        ...
                        <div class="col-sm-5 align-self-center">
                            <a href="<?=base_url()?>opciones_sistema/detalle/<?=$opciones_sistema_item['cve_opcion']?>"><?= $opciones_sistema_item['nom_opcion'] ?></a>
                        </div>
                        <div class="col-sm-1">
                            <a style="color: #f00" href="<?= base_url() ?>opciones_sistema/eliminar/<?= $opciones_sistema_item['cve_opcion'] ?>/"><span data-feather="x-circle"></span></a>
                        </div>
                    </div>
                </div>
                <?php } ?>
