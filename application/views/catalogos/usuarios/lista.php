            ...
            <div class="row">
                ...
                <div class="col-sm-12 alternate-color">
                    <div class="row">
                        ...
                        <div class="col-sm-3 align-self-center">
                            <a href="<?=base_url()?>usuarios/detalle/<?=$usuarios_item['cve_usuario']?>"><?= $usuarios_item['nom_usuario'] ?></a>
                        </div>
                        <div class="col-sm-2 align-self-center">
                        ...
                        <div class="col-sm-1">
                            <a style="color: #f00" href="<?= base_url() ?>usuarios/eliminar/<?= $usuarios_item['cve_usuario'] ?>/"><span data-feather="x-circle"></span></a>
                        </div>
                    </div>
                </div>
                <?php } ?>
